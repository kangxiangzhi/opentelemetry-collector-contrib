...
type JVMMetricReportServiceClient interface {
	Collect(ctx context.Context, in *agentv3.JVMMetricCollection, opts ...grpc.CallOption) (*v3.Commands, error)
}
...
func (c *jVMMetricReportServiceClient) Collect(ctx context.Context, in *agentv3.JVMMetricCollection, opts ...grpc.CallOption) (*v3.Commands, error) {
	out := new(v3.Commands)
...
type JVMMetricReportServiceServer interface {
	Collect(context.Context, *agentv3.JVMMetricCollection) (*v3.Commands, error)
...
func (UnimplementedJVMMetricReportServiceServer) Collect(context.Context, *agentv3.JVMMetricCollection) (*v3.Commands, error) {
...
func _JVMMetricReportService_Collect_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(agentv3.JVMMetricCollection)
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(JVMMetricReportServiceServer).Collect(ctx, req.(*agentv3.JVMMetricCollection))
	}
