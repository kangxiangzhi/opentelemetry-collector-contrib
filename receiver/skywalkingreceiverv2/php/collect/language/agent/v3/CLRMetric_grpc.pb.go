...
type CLRMetricReportServiceClient interface {
	Collect(ctx context.Context, in *agentv3.CLRMetricCollection, opts ...grpc.CallOption) (*v3.Commands, error)
}
...
func (c *cLRMetricReportServiceClient) Collect(ctx context.Context, in *agentv3.CLRMetricCollection, opts ...grpc.CallOption) (*v3.Commands, error) {
	out := new(v3.Commands)
...
type CLRMetricReportServiceServer interface {
	Collect(context.Context, *agentv3.CLRMetricCollection) (*v3.Commands, error)
...
func (UnimplementedCLRMetricReportServiceServer) Collect(context.Context, *agentv3.CLRMetricCollection) (*v3.Commands, error) {
...
func _CLRMetricReportService_Collect_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(agentv3.CLRMetricCollection)
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(CLRMetricReportServiceServer).Collect(ctx, req.(*agentv3.CLRMetricCollection))
	}
